	...
	Ext.apply(config, {
		...
		,{
			...
			,cmd:'delete'
			 ...
			 text:this.createText + ' (' + this.createKeyName + ')'
		...
		,{
			...
			,new Ext.ux.UploadPanel(Ext.apply(uploadPanelConfig, {hideOnClick:false ,cmd:'upload-panel'}))
//			,{
//				 hideOnClick:false
//				,cmd:'upload-panel'
//			})
...
Ext.extend(Ext.ux.FileTreeMenu, Ext.menu.Menu, {
	...
	/**
	 * @cfg {String} createIconCls icon class for create item
	 */
	,createIconCls:'icon-create'
	...
	/**
	 * @cfg {String} createKeyName text for create item shortcut
	 */
	,createKeyName:'Ins Key'
	...
	/**
	 * @cfg {String} createText text for create item
	 */
	,createText:'Create File'
